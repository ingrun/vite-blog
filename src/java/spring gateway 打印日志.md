...
[转自](https://juejin.cn/post/7055125625085902878)
...
import com.fxszgs.zhfxgateway.entity.GatewayLog;
        ...
        return new ServerHttpResponseDecorator(response) {
            ...
            public Mono<Void> writeWith(Publisher<? extends DataBuffer> body) {
                if (body instanceof Flux) {
                    ...
                    if (this.getStatusCode() == HttpStatus.OK && StringUtils.isNotBlank(originalResponseContentType) && originalResponseContentType.contains("application/json")) {
